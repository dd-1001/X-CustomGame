...
require("tweak.07_machine")      -- 机器-------采矿机(含：抽油机)、熔炉(含：回收机)、组装机(含：铸造厂、生物室、虫巢孵化器、炼油厂、化工厂、离心机、电磁工厂、低温工厂、破碎机、)
-- require("tweak.08_resource") -- 资源-------燃料的热值、卫星
-- require("tweak.09_other") -- 其他-------火车、车、蜘蛛机甲、修理工具、研究中心、插件效果分享塔、插件、火箭发射井、雷达
