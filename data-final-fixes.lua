...
require("tweak.07_machine")      -- 机器-------采矿机(含：抽油机)、熔炉(含：回收机)、组装机(含：铸造厂、生物室、虫巢孵化器、炼油厂、化工厂、离心机、电磁工厂、低温工厂、破碎机)、农业塔、研究中心、避雷针(含：闪电捕捉器)
require("tweak.08_module")       -- 插件-------插件效果分享塔、
require("tweak.09_item")         -- 中间产品-------堆叠倍数、燃料加成
